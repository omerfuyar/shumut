...
int main(int argc, char **argv)
{
    ...
    while (SHU_AtomicRead(&counter) < COUNTER_MIN_LIMIT)
    {
    }

    SHU_LogInfo("main thread exiting, counter %zu", SHU_AtomicRead(&counter));
